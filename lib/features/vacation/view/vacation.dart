...
import 'package:boilerplate/features/vacation/view/detail_screen.dart';
...
class Vacation extends BaseStateFulWidget {
...
class _VacationState extends BaseStateFulWidgetState<Vacation> {
  List<String> images = [
  ...
  late VacationCubit vacationCubit;
  ...
  void initState() {
    ...
    debugPrint(
      Injector.instance<AuthService>().loginStartTime,
    );
    debugPrint(
      Injector.instance<AuthService>().loginEndTime,
    );
    vacationCubit = VacationCubit();
    Future.delayed(
      const Duration(seconds: 2),
      () => vacationCubit.checkAuthentication(),
    );
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: BlocListener<VacationCubit, VacationState>(
