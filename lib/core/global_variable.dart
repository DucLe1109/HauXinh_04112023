...
const Duration fastAnimationDuration = Duration(milliseconds: 300);
const Duration normalAnimationDuration = Duration(milliseconds: 600);
const double borderRadius = 12;
const double borderRadiusAvatar = 16;
