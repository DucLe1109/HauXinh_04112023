...
/// See also:
///
///   * [CustomInteractiveViewer.builder], whose builder is of this type.
...
///
/// By default, CustomInteractiveViewer clips its child using [Clip.hardEdge].
/// To prevent this behavior, consider setting [clipBehavior] to [Clip.none].
/// When [clipBehavior] is [Clip.none], CustomInteractiveViewer may draw outside of
...
/// To prevent dead areas where CustomInteractiveViewer does not receive gestures,
/// don't set [clipBehavior] or be sure that the CustomInteractiveViewer widget is the
...
///     which includes the use of CustomInteractiveViewer.
///   * The [flutter-go demo](https://github.com/justinmc/flutter-go), which includes robust positioning of an CustomInteractiveViewer child
///     that works for all screen sizes and child sizes.
///   * The [Lazy Flutter Performance Session](https://www.youtube.com/watch?v=qax_nOpgz7E), which includes the use of an CustomInteractiveViewer to
...
class CustomInteractiveViewer extends StatefulWidget {
  /// Create an CustomInteractiveViewer.
  ///
  ...
  /// Creates an CustomInteractiveViewer for a child that is created on demand.
  ///
  ...
  /// If set to [Clip.none], the child may extend beyond the size of the CustomInteractiveViewer,
  /// but it will not receive gestures in these areas.
  /// Be sure that the CustomInteractiveViewer is the desired size when using [Clip.none].
  ///
  ...
  /// The child [Widget] that is transformed by CustomInteractiveViewer.
  ///
  ...
  /// is often useful when a child should be bigger than the CustomInteractiveViewer.
  ///
  ...
  ///
  /// {@template flutter.widgets.CustomInteractiveViewer.onInteractionEnd}
  ...
  ///
  /// A [GestureDetector] wrapping the CustomInteractiveViewer will not respond to
  ...
  /// listeners are notified. If the value is set, CustomInteractiveViewer will update
